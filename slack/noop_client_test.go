...
func TestNoopClient_SendError(t *testing.T) {
	Convey("Given a NoopClient", t, func() {
		...
		Convey("When SendAlarm is called", func() {
			ref, err := client.SendAlarm(context.Background(), "Test Title", errors.New("Test Error"), nil, nil)
...
func TestNoopClient_SendWarning(t *testing.T) {
	Convey("Given a NoopClient", t, func() {
		...
		Convey("When SendWarning is called", func() {
			ref, err := client.SendWarning(context.Background(), "Test Title", nil, nil)
...
func TestNoopClient_SendInfo(t *testing.T) {
	Convey("Given a NoopClient", t, func() {
		...
		Convey("When SendInfo is called", func() {
			ref, err := client.SendInfo(context.Background(), "Test Title", nil, nil)
...
func TestNoopClient_SendPublishLog(t *testing.T) {
	Convey("Given a NoopClient", t, func() {
		...
		Convey("When SendPublishLog is called", func() {
			ref, err := client.SendPublishLog(context.Background(), "Test Title", nil, nil)
...
func TestNoopClient_UpdateMessage(t *testing.T) {
	Convey("Given a NoopClient", t, func() {
		client := &slack.NoopClient{}

		Convey("When UpdateMessage is called", func() {
			ref, err := client.UpdateMessage(context.Background(), &slack.MessageRef{ChannelID: "test-channel", Timestamp: "1234567890.123456"}, "Test Title", nil, nil, nil, slack.RedColour, slack.AlarmEmoji)
