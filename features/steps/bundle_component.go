	...
	permissionsAPIClient := &permissionsAPISDKMock.ClienterMock{
		PostPolicyFunc: func(ctx context.Context, policy permissionsAPIModels.PolicyInfo) (*permissionsAPIModels.Policy, error) {
			createdPolicy := &permissionsAPIModels.Policy{
				// Simplify ID for testing purposes, in reality this would be a UUID generated by the permissions API
				ID:        strings.TrimPrefix(policy.Entities[0], "groups/"), // assume only one entity per policy
