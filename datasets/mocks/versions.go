...
//			GetForContentItemFunc: func(ctx context.Context, contentItem models.ContentItem) (*datasetmodels.Version, error) {
...
func (mock *DatasetsVersionsClientMock) GetForContentItem(ctx context.Context, contentItem models.ContentItem) (*datasetmodels.Version, error) {
	...
	return mock.GetForContentItemFunc(ctx, contentItem)
}
...
func (mock *DatasetsVersionsClientMock) UpdateStateForContentItem(ctx context.Context, contentItem models.ContentItem, targetState models.BundleState) error {
	...
	return mock.UpdateStateForContentItemFunc(ctx, contentItem, targetState)
}
