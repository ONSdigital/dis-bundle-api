module github.com/ONSdigital/dis-bundle-api
...
require (
	...
	github.com/ONSdigital/dp-dataset-api v1.81.1-0.20250616080433-4a4d3bd8664a
...
require (
	...
	github.com/ONSdigital/dp-kafka/v4 v4.1.0 // indirect
