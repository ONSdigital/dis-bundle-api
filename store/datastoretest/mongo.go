...
func (mock *MongoDBMock) CheckBundleExists(ctx context.Context, bundleID string) (bool, error) {
	if mock.CheckBundleExistsFunc == nil {
		panic("MongoDBMock.CheckBundleExistsFunc: method is nil but MongoDB.CheckBundleExists was just called")
	}
	callInfo := struct {
		Ctx      context.Context
		BundleID string
...
func (mock *MongoDBMock) CheckBundleExistsByTitleUpdate(ctx context.Context, title string, excludeID string) (bool, error) {
	if mock.CheckBundleExistsByTitleUpdateFunc == nil {
		panic("MongoDBMock.CheckBundleExistsByTitleUpdateFunc: method is nil but MongoDB.CheckBundleExistsByTitleUpdate was just called")
	}
	callInfo := struct {
		Ctx       context.Context
		Title     string
...
func (mock *MongoDBMock) CheckContentItemExistsByDatasetEditionVersion(ctx context.Context, datasetID string, editionID string, versionID int) (bool, error) {
	if mock.CheckContentItemExistsByDatasetEditionVersionFunc == nil {
		panic("MongoDBMock.CheckContentItemExistsByDatasetEditionVersionFunc: method is nil but MongoDB.CheckContentItemExistsByDatasetEditionVersion was just called")
	}
	callInfo := struct {
		Ctx       context.Context
		DatasetID string
...
func (mock *MongoDBMock) CreateContentItem(ctx context.Context, contentItem *models.ContentItem) error {
	if mock.CreateContentItemFunc == nil {
		panic("MongoDBMock.CreateContentItemFunc: method is nil but MongoDB.CreateContentItem was just called")
	}
	callInfo := struct {
		Ctx         context.Context
		ContentItem *models.ContentItem
...
func (mock *MongoDBMock) GetBundle(ctx context.Context, bundleID string) (*models.Bundle, error) {
	if mock.GetBundleFunc == nil {
		panic("MongoDBMock.GetBundleFunc: method is nil but MongoDB.GetBundle was just called")
	}
	callInfo := struct {
		Ctx      context.Context
		BundleID string
...
func (mock *MongoDBMock) GetContentItemsByBundleID(ctx context.Context, bundleID string) ([]*models.ContentItem, error) {
	if mock.GetContentItemsByBundleIDFunc == nil {
		panic("MongoDBMock.GetContentItemsByBundleIDFunc: method is nil but MongoDB.GetContentItemsByBundleID was just called")
	}
	callInfo := struct {
		Ctx      context.Context
		BundleID string
...
func (mock *MongoDBMock) ListBundleContents(ctx context.Context, bundleID string, offset int, limit int) ([]*models.ContentItem, int, error) {
	if mock.ListBundleContentsFunc == nil {
		panic("MongoDBMock.ListBundleContentsFunc: method is nil but MongoDB.ListBundleContents was just called")
	}
	callInfo := struct {
		Ctx      context.Context
		BundleID string
...
func (mock *MongoDBMock) ListBundleEvents(ctx context.Context, offset int, limit int, bundleID string, after *time.Time, before *time.Time) ([]*models.Event, int, error) {
	if mock.ListBundleEventsFunc == nil {
		panic("MongoDBMock.ListBundleEventsFunc: method is nil but MongoDB.ListBundleEvents was just called")
	}
	callInfo := struct {
		Ctx      context.Context
		Offset   int
...
func (mock *MongoDBMock) UpdateBundleETag(ctx context.Context, bundleID string, email string) (*models.Bundle, error) {
	if mock.UpdateBundleETagFunc == nil {
		panic("MongoDBMock.UpdateBundleETagFunc: method is nil but MongoDB.UpdateBundleETag was just called")
	}
	callInfo := struct {
		Ctx      context.Context
		BundleID string
...
func (mock *MongoDBMock) UpdateContentItemDatasetInfo(ctx context.Context, contentItemID string, title string, state string) error {
	if mock.UpdateContentItemDatasetInfoFunc == nil {
		panic("MongoDBMock.UpdateContentItemDatasetInfoFunc: method is nil but MongoDB.UpdateContentItemDatasetInfo was just called")
	}
	callInfo := struct {
		Ctx           context.Context
		ContentItemID string
...
func (mock *MongoDBMock) UpdateContentItemMetadataAndLinks(ctx context.Context, contentItemID string, datasetID string, editionID string, editLink string, previewLink string) error {
	if mock.UpdateContentItemMetadataAndLinksFunc == nil {
		panic("MongoDBMock.UpdateContentItemMetadataAndLinksFunc: method is nil but MongoDB.UpdateContentItemMetadataAndLinks was just called")
	}
	callInfo := struct {
		Ctx           context.Context
		ContentItemID string
...
// Check the length with:
//
//	len(mockedMongoDB.UpdateContentItemMetadataAndLinksCalls())
func (mock *MongoDBMock) UpdateContentItemMetadataAndLinksCalls() []struct {
	Ctx           context.Context
	ContentItemID string
	DatasetID     string
	EditionID     string
